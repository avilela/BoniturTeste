...
class AttractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post attractions_url, params: { attraction: { address: @attraction.address, company_id: @attraction.company_id, duration_time: @attraction.duration_time, max_people: @attraction.max_people, name: @attraction.name, price: @attraction.price } }
    end
  ...
  test "should update attraction" do
    patch attraction_url(@attraction), params: { attraction: { address: @attraction.address, company_id: @attraction.company_id, duration_time: @attraction.duration_time, max_people: @attraction.max_people, name: @attraction.name, price: @attraction.price } }
